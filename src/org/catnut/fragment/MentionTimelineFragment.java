...
public class MentionTimelineFragment extends TimelineFragment {
	...
	public static final String TAG = MentionTimelineFragment.class.getSimpleName();
	...
	public static MentionTimelineFragment getFragment() {
	...
	public void onAttach(Activity activity) {
		...
		mSelection = new StringBuilder(Status.TYPE)
				.append("=").append(Status.MENTION).toString();
	}
