...
public class TweetAPI {
	...
	private static final String BASE_URI = TingtingAPI.API_DOMAIN + "/2/statuses/";
	 ...
	 * @return api
	 */
	public static TingtingAPI homeTimeline(long since_id, long max_id, int count, int page, int base_app, int feature, int trim_user) {
		StringBuilder uri = new StringBuilder(BASE_URI);
	 ...
	 * @return api
	 */
	public static TingtingAPI userTimeline(long uid, long since_id, long max_id, int count, int page, int base_app, int feature, int trim_user) {
		StringBuilder uri = new StringBuilder(BASE_URI);
		uri.append("user_timeline.json")
			.append("?uid=").append(uid)
			.append("&since_id=").append(TingtingUtils.optValue(since_id, 0))
